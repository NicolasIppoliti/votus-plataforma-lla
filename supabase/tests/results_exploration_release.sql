...
begin
  ...
  if to_regprocedure('public.results_exploration_official_0034(uuid,uuid,text,text,text,text,integer,text)') is null
    ...
    raise exception '0034 forward apply omitted the null-safe district core or preserved history'; end if;
  ...
  if has_function_privilege('authenticated', 'public.results_exploration_official_0034(uuid,uuid,text,text,text,text,integer,text)', 'EXECUTE')
    ...
    raise exception '0034 internal RPCs remained directly executable'; end if;
  if (select p.proowner <> 'results_exploration_executor'::regrole from pg_proc p
      where p.oid='public.results_exploration_official_0034(uuid,uuid,text,text,text,text,integer,text)'::regprocedure)
    ...
    raise exception '0034 RPC ownership was not preserved'; end if;
...
\else
  ...
  \quit 1
\endif
select 'release-proof' as evidence, 34 as migration_inventory_count, '0034-down,0033-down,0032-down,0031-down,0030-down,0029-down,0028-down,0027-down,0026-down,0025-down,0023-down,0022-down,0021-down,0020-down,0020-up,0021-up,0022-up,0023-up,0025-up,0026-up,0027-up,0028-up,0029-up,0030-up,0031-up,0032-up,0033-up,0034-up' as migration_sequence, 'authenticated-execute/anon-denied/internal-denied' as grant_state;
