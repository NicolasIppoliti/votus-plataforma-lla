...
alter function results_exploration_official_wrapper_0033(uuid,uuid,text,text,text,text,integer,text)
...
grant execute on function results_exploration_official(uuid,uuid,text,text,text,text,integer,text)
  to authenticated;
drop function results_exploration_official_0034(uuid,uuid,text,text,text,text,integer,text);
commit;
