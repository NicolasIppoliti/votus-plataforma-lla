...
revoke execute on function results_exploration_facets(uuid,uuid,text,text,text) from public;
revoke execute on function results_exploration_facets(uuid,uuid,text,text,text) from anon;
grant execute on function results_exploration_facets(uuid,uuid,text,text,text) to authenticated;
