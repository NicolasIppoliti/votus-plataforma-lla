...
DINE_2023_MUNICIPAL_MIGRATION_VERSION = "20260923000000"
DINE_2023_MUNICIPAL_IDENTITIES_VERSION = "20260923000001"
...
SUPPORTED_TIMESTAMP_MIGRATION_VERSIONS = frozenset(
    {
        ...
        DINE_2023_MUNICIPAL_MIGRATION_VERSION,
        DINE_2023_MUNICIPAL_IDENTITIES_VERSION,
    }
)
...
def test_migration_inventory_accepts_exact_mixed_version_history() -> None:
    ...
    assert len(EXPECTED_MIGRATION_VERSIONS) == 67
