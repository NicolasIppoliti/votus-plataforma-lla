import { loadSafeFiscalizacionResult, normalizeFiscalizacionEvidenceRequest } from "../../../../../lib/workspace/fiscalizacion-evidence";
...
export async function GET(request: Request): Promise<Response> {
  try {
    ...
    return Response.json(await loadSafeFiscalizacionResult(selection, optIn), { headers: PRIVATE_HEADERS });
  } catch (error) {
