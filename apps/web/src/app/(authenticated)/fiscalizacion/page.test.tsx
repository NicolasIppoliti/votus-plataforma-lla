  ...
  it("test_zero_rows_is_not_reported_as_a_mapping_failure", async () => {
	...
	it("renders distinct unknown exclusion reasons once as escaped text", async () => {
      ...
      it("renders valid injected coverage after the rendered-page guard", async () => {
        ...
        expect(markup).toContain("/api/workspace/fiscalizacion/result?election_id=20000000-0000-0000-0000-000000000001&amp;category_id=20000000-0000-0000-0000-000000000003&amp;distrito_code=02&amp;seccion_code=027&amp;opt_in=true");
        expect(markup).toContain("Consultar resultado autorizado de fiscalización");
