...
function result(year: number, sourceGranularity: "mesa" | "seccion", archiveEntryId: string) { return { status: "ok", source_kind: "official", category_name: `Category ${year}`, level: "seccion", source_granularity: sourceGranularity, election_year: year, election_round: "generales", total_votes: 100, mesa_count: sourceGranularity === "mesa" ? 1 : null, parties: [{ identity_status: "canonical", canonical_party_id: "canonical-party", display_name: year === 2023 ? "Party 2023" : "Party 2025", list_id: null, votes: 100, vote_share: "1" }], source_audit: [{ kind: "official", rows: 1, votes: 100 }], source_exclusions: sourceExclusions.map((entry) => ({ ...entry })), archive_entry_ids: [archiveEntryId], truncated: false }; }
